...
do
    echo $A
    v.out.ogr input=streams_$A output=streams_$A.gpkg
done
...
do
    ...
    v.out.ogr input=streams_${A}_inbasin output=streams_${A}_inbasin.gpkg --o
done
...
do
    echo $A
    v.out.ogr input=streams_${A}_buffered_inbasin output=streams_${A}_buffered_inbasin.gpkg --o
done
